...
jQuery(document).on('click', '.extra-fields-type', function(e) {
  ...
  jQuery(document).on('click', '.remove-field', function(e) {
	...
	var removeData = document.querySelector('#mlm_card button.update-type-product').dataset.remove_id;
	removeData =JSON.parse(removeData);
	removeData.push(data);
	console.log(removeData,data);
	document.querySelector('#mlm_card button.update-type-product').dataset.remove_id = JSON.stringify(removeData);
	
	console.log(document.querySelector('#mlm_card button.update-type-product').dataset.remove_id);
	
  });



  jQuery(document).on('click', '#mlm_card button.update-type-product', function(e) {
	e.preventDefault();
...
var data_pass={
	...
	product_id:document.querySelector('#mlm_card').dataset.product_id,
